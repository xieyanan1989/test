...
public class UserSupplyServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("UserSupplyServlet sig="+sig+" json="+json);
		...
		try {
			...
			Map map = service.getUsersProduct(username,saletype,pagenum,pagesize);
