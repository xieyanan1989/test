...
//        System.out.println(Math.abs(item.hashCode()));
...
//        hash.desc();  
//        
//        hash.addNode("Machine-18");  
//        hash.addNode("Machine-19");  
//        hash.addNode("Machine-20");  
//        hash.addNode("Machine-21");  
//        hash.addNode("Machine-22");  
//        hash.addNode("Machine-23");  
//        hash.desc();  
    }  
